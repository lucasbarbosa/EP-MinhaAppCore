...
namespace DevIO.UI.Site
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Transient: Obtém uma nova instância do objeto a cada solicitação
            services.AddTransient<IPedidoRepository, PedidoRepository>();
            services.AddTransient<IOperacaoTransient, Operacao>(); // Transient: Obtém uma nova instância do objeto a cada solicitação

            // Scoped: Reutiliza a mesma instância do objeto durante todo o request (web)
            services.AddScoped<IOperacaoScoped, Operacao>();
            
            // Singleton: Utiliza a mesma instância para toda a aplicação (cuidado)
